...
The functions generates the conflict of interest statement section of
the manuscript. The output is generated from an contributors_table based
on the
...
``` r
print_conflict_statement(contributors_table, initials = FALSE)
```
