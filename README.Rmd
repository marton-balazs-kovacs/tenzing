...
[![Codecov test coverage](https://codecov.io/gh/marton-balazs-kovacs/tenzing/branch/master/graph/badge.svg)](https://codecov.io/gh/marton-balazs-kovacs/tenzing?branch=master)
<!-- badges: end -->
...
[CRediT](https://www.casrai.org/credit.html) (Contributor Roles Taxonomy) is a high-level taxonomy of 14 roles designed to represent the roles typically played by contributors to scientific scholarly output. The roles indicate each contributor’s contributions to a scholarly project.
...
* create a YAML output that will automatically add the contributorship information to the `papaja`package used by some researchers to write APA-formatted manuscripts
...
Install the development version (tenzing is not available from CRAN) from [GitHub](https://github.com/) with:
...
We would like tenzing to be make any contributorship-related task easy for researchers, so we are open to new ideas and feature requests.
