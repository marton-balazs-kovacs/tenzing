...
You can copy the Google spreadsheet and fill out the copy with your contributorship information. However, you can use the template built in the application as a dataset. To get more information on the infosheet tempalte use the `?tenzing::infosheet_template` command.

You can write the template to your root folder as an xlsx file for easy edit.
